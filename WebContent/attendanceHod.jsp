...
<div class="logo">
  ...
  <div align="center">
			<h2>
				<font style="color: Red">Attendance < 60% Student Details</font>
			</h2>
			<table cellpadding="3" cellspacing="3" align="center" border="1">
				...
				try{
					...
					PreparedStatement ps=con.prepareStatement("SELECT * FROM `student_academic` where attendance<60 and dept='"+dept1+"'");
