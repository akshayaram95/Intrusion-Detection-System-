			...
			<div class="header_resize">
				<div class="menu_nav">
					<ul>
						...
						<li><a href="noticeFaculty.jsp"><span>Notice</span></a></li>
		...
		<div>
			...
			<table border="1">
				...
				<tr>
					...
					<td><%=dept %></td>
					<td><%=year %></td>
					<td><%-- <a href="personalInfEdit.jsp?sid=<%=sid%>">Personal Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="parentInfEdit.jsp?sid=<%=sid%>">Parent Info</a>&nbsp;&nbsp;&nbsp;| --%>&nbsp;&nbsp;&nbsp;<a href="acdInfoEditStudent.jsp?sid=<%=sid%>">Academic Info</a> </td>
				</tr>
			</table>
	</div>
	<br/>
