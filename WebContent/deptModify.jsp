		...
		<div>
			...
			if(request.getParameter("uname")!=null)
			{
				...
				try
				{
					...
					{
						response.sendRedirect("deptModify.jsp?not=found");
			...
			<table border="1">
				...
				<tr>
					...
					<td><%=dept %></td>
					<td><%=year %></td>
					<td><a href="personalInfEditDept.jsp?sid=<%=sid%>">Personal Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="parentInfEditDept.jsp?sid=<%=sid%>">Parent Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="acdInfoEditDept.jsp?sid=<%=sid%>">Academic Info</a> </td>
				</tr>
			</table>
	</div>
	<br/>
