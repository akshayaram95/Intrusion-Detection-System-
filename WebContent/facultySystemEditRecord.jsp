		...
		<div align="center">
			...
			if(request.getParameter("fid")!=null)
			{
				...
				try
				{
					...
					PreparedStatement ps=con.prepareStatement("SELECT * FROM `fac_personal` where fid='"+fid+"'");
					...
					{
			%>
				<form action="UpdateFacultySystem" name="uRegi" method="post"
					onsubmit="return Regvalidation()">
					<h2 align="center">
						<b>Faculty Personal Detail Edit...!</b>
					</h2>
					<table cellpadding="5" cellspacing="5" align="center">
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="pno" pattern="[7|8|9][0-9]{9}" value="<%=rs.getString(4) %>"
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="email" id="email" value="<%=rs.getString(5) %>"
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="bdate" id="passwords" value="<%=rs.getString(6) %>"
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="pan_no" id="passwords" value="<%=rs.getString(10) %>"
								maxlength="20" required /></td>
						</tr>
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="desg" id="desg" value="<%=rs.getString(11) %>"
								maxlength="20" required /></td>
						</tr>
