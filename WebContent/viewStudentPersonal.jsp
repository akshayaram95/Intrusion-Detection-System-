	...
	<div class="main">
		...
		<div align="center">
			...
			%>
				...
				<form action="UpdatePersonal" name="uRegi" method="post"
					...
					<table cellpadding="5" cellspacing="5" align="center">
						...
						<tr>
							...
							<td><input type="text" name="fname" id="fname" value="<%=rs.getString(2) %>" required /> <input type="hidden" name="Usertype"
								id="Usertype" value="User"  readonly="readonly"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							%>
							<td>
							<select  name="gender" id="gender"  required readonly="readonly">
						...
						<tr>
							...
							<td><input type="text" name="pno" pattern="[7|8|9][0-9]{9}" value="<%=rs.getString(5) %>"
								id="contactNo" placeholder="1234567890" maxlength="10" required readonly="readonly"  /></td>
						</tr>
						<tr>
							...
							<td><input type="text" name="email" id="email" value="<%=rs.getString(6) %>"
								placeholder="abc@gmail.com" maxlength="50" required readonly="readonly"/></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" name="bdate" id="passwords" value="<%=rs.getString(7) %>"
								maxlength="20" required readonly="readonly"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="ano" id="passwords" value="<%=rs.getString(9) %>"
								maxlength="12" required  readonly="readonly"/></td>
						</tr>
					<%-- 	<tr>
