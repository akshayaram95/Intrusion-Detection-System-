...
<div class="logo">
  ...
  <form action="Fac_Personal_detail" name="uRegi" method="post" onsubmit="return Regvalidation()">
			<h2 align="center"><b>Faculty Personal Detail Form...!</b></h2> 
	        <table cellpadding="5" cellspacing="5" align="center" >
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td>
					<input type="text" name="fullname" id="fname"  maxlength="20" required/>
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td><input type="text" name="add" id="lname"  maxlength="20" required/></td>
				</tr>
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td><input type="text" name="email" id="email" placeholder="abc@gmail.com" maxlength="50" required/></td>
				</tr>
				
				<tr>
					<td><strong>Date Of Birth</strong></td>
					<td><strong>:</strong></td>
					<td><input type="text" name="bdate" id="passwords"  maxlength="20" required/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td><input type="text" name="bno" id="passwords"  maxlength="20" required/></td>
				</tr>
				<tr>
					<td><strong>Adhar Card No</strong></td>
					<td><strong>:</strong></td>
					<td><input type="text" name="ano" id="passwords"  maxlength="20" required/></td>
				</tr>
				<tr>
					<td><strong>Pan Card No</strong></td>
					<td><strong>:</strong></td>
					<td><input type="text" name="panno" id="passwords"  maxlength="20" required/></td>
				</tr>
				<tr>
					
					<td><strong>Designation</strong></td>
					<td><strong>:</strong></td>
					<td><select name="des"  required>
					
					<option name="male" value="principal">Principal</option>
					<option name="female" value="hod">HOD</option>
					<option name="female" value="professor">Professor</option>
					<option name="female" value="labasistant">Lab Asistant</option>
					</select></td>
				</tr>
				<tr>
