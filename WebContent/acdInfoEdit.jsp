...
<body>
 ...
 --%>					<tr>
					...
					<tr>
						...
						<td><strong>:</strong></td>
						<td><input type="text" name="utmark" id="passwords" value="<%=rs.getString(10) %>" maxlength="2" required />(OUt of 10%)</td>
					</tr>
					<tr>
						<td><strong>University Marks</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="umark" id="passwords" value="<%=rs.getString(11) %>" maxlength="3" required />(OUt of 100%)</td>
					</tr>
					<tr>
						<td><strong>Attendance</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="attend" id="passwords" maxlength="3" value="<%=rs.getString(12) %>"
							maxlength="20" required />(OUt of 100%)</td>
					</tr>
					<tr>
						<td><strong>Fees</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="fees" id="passwords" value="<%=rs.getString(13) %>"
							maxlength="20" required /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><strong>:</strong></td>
						<td><input type="text" name="pdetails" id="passwords" value="<%=rs.getString(16) %>"
							maxlength="20" required /></td>
					</tr>
					<tr>
						<td><strong>Paper Publication Details</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="paper_details"  id="passwords" value="<%=rs.getString(17) %>"
							maxlength="20" required /></td>
					</tr>
					<tr>
						<td><strong>Extra-Curricular activities</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="extra" id="passwords" value="<%=rs.getString(18) %>"
							maxlength="20" required /></td>
					</tr>
					<tr>
						<td><strong>Internship/Project Sponsorship details.</strong></td>
						<td><strong>:</strong></td>
						<td><input type="text" name="spons_detail"  id="passwords" value="<%=rs.getString(19) %>"
							maxlength="20" required /></td>
					</tr>
					<tr>
