...
<body>
	<div class="main">
		...
		<div>
			<form action="DeanLogin" method="post">
				<h2 align="center">
				...
				<table cellpadding="5" cellspacing="5" align="center">
					...
					<tr>
						...
						<td><strong>:</strong></td>
						<td><input type="text" name="email" id="email" placeholder="Email ID" required /></td>
					</tr>
					<tr>
						<td><strong>Password</strong></td>
						<td><strong>:</strong></td>
						<td><input class="" type="password" name="pwd" id="pwd" placeholder="********" maxlength="20" required /></td>
					</tr>
					<tr>
