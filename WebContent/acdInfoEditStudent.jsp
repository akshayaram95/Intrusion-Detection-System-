			...
			<form action="UpdateAcademic" name="uRegi" method="post"
				...
				<table cellpadding="3" cellspacing="3" align="center">
					...
					<tr>
						...
						<td><strong>:</strong></td>
						<td><input type="password" name="pass" value="<%=rs.getString(3) %>" readonly="readonly" id="lname"
					...
					<tr>
						...
						<td><strong>:</strong></td>
						<td><input type="text" name="year" id="email" maxlength="50" value="<%=rs.getString(5) %>" required /></td>
					</tr>
<%-- 
					<tr>
