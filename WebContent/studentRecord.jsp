		...
		<div align="center">
			...
			<table cellpadding="3" cellspacing="3" align="center" border="1">
				...
				<tr align="center">
					...
					<td><%=email %></td>
					<td><%=uname %></td>
					<td><a href="personalInfEditRecord.jsp?sid=<%=sid%>">Personal Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="parentSystemEditRecord.jsp?sid=<%=sid%>">Parent Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="academicSystemEditRecord.jsp?sid=<%=sid%>">Academic Info</a> </td>
