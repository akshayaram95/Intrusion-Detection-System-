...
<body>
	<div class="main">
		...
		<div></div>
		<div align="center">
			<h2>WELCOME TO INTRUSION DETECTION SYSTEM</h2>
			</br>
			</br>

			<div>
				<form action="SystemLogin" method="post">
					<h2 align="center">
						<b>System Login..!!!</b>
					</h2>
					<table cellpadding="5" cellspacing="5" align="center">
						...
						<tr>
							...
							<td><strong>:</strong></td>
							<td><input type="text" name="uname" id="username" placeholder="User Name" required /></td>
						</tr>
						<tr>
							<td><strong>Password</strong></td>
							<td><strong>:</strong></td>
							<td><input class="" type="password" name="pwd"
								id="password" placeholder="********" maxlength="20" /></td>
						</tr>
						<tr>
