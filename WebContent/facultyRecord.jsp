...
<body>
	<div class="main">
		...
		<div align="center">
			<h2>
				<font style="color: Red">All Faculty Details</font>
			</h2>
			<table cellpadding="3" cellspacing="3" align="center" border="1">
				...
				try{
					...
					PreparedStatement ps=con.prepareStatement("SELECT * FROM `fac_personal`");
				...
				<tr align="center">
					...
					<td><%=email %></td>
					<td><%=uname %></td>
					<td><a href="facultySystemEditRecord.jsp?fid=<%=fid%>">Personal Info</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="parentSystemEditRecord.jsp?fid=<%=fid%>">Organizational Info</a> </td>
